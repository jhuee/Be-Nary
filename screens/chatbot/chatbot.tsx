...
// 사용자 입력 필드
const userInput = document.querySelector<HTMLInputElement>('#user-input input');
// 전송 버튼
const sendButton = document.querySelector<HTMLButtonElement>('#user-input button');
...
function addMessage(sender: string, message: string) {
    ...
    if (!chatMessages) return; // null 체크를 통해 오류 방지
    // 생성된 요소에 클래스 추가
...
sendButton?.addEventListener('click', async () => {
   // userInput이 null이거나 빈 값일 경우 빠른 종료
